...
export function PlaybookStep({
  ...
  const downloadPlaybook = () => {
    // Format playbook for CopyCoach compatibility
    const playbook = {
      generatedAt: new Date().toISOString(),
      version: '2.0',
      audienceResearch: {
        transformationJourney: {
          currentState: research.audienceState?.currentState || 'Not specified',
          desiredState: research.audienceState?.desiredState || 'Not specified',
        },
      ...
      contentHooks: {
        lovedHooks: lovedHooks.map(h => ({
          text: h.text,
          category: h.category as 'curiosity' | 'identity' | 'pain_agitation' | 'contrarian',
        })),
      ...
      offerCore: offerCore ? {
        offerStatement: {
          finalStatement: offerCore.offerStatement.finalStatement,
          emotionalCore: offerCore.offerStatement.emotionalCore,
          universalMotivatorsUsed: offerCore.offerStatement.universalMotivatorsUsed,
          templateUsed: offerCore.offerStatement.templateUsed,
        },
        benefits: offerCore.theOfferGivesYou,
        useCases: offerCore.youCanUseItTo,
        hiddenBenefits: offerCore.hiddenBenefits,
        programNameOptions: offerCore.programNameOptions.map(opt => ({
          name: opt.name,
          uniqueMechanism: opt.uniqueMechanism,
          rationale: opt.rationale,
        })),
      } : {
        // Default placeholder if offerCore not completed
        offerStatement: {
          finalStatement: 'Complete the Offer Core step to generate your offer statement',
          emotionalCore: '',
      ...
      _instructions: 'This Brand Playbook was generated by BraveBrand Intelligence. Upload this file to CopyCoach to power your copywriting with real audience insights.',
    }
