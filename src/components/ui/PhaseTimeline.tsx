              ...
              >
                <div
                  className={`
                    ...
                    ${isActive
                      ? 'bg-[#16314C] text-white shadow-lg scale-110'
                      : 'bg-gray-100 text-gray-600 group-hover:bg-[#BBDCEF]/50 group-hover:text-[#16314C]'
                    }
                  `}
                >
                  {phase.phase}
                ...
                <span
                  className={`
                    ...
                    ${isActive ? 'text-[#16314C] font-medium' : 'text-gray-500'}
                  `}
                >
                  {phase.name}
                </span>
